		...
		if(confirm("기본 정보를 수정 하시겠습니까?")){
			$.ajax({
	       		...
	       		success : function(data) {
	       			if(data.code == '0000'){
	       				alert("코드 그룹 정보가 수정 되었습니다.");
	       				fn_list();
	       			}else{
	       				alert("코드 그룹 정보 수정 중 오류가 발생 하였습니다.");
	       				fn_list();
	       			}
				},
...
<body>
	...
	<input type="hidden" name="grpCodeId" value="<c:out value="${detail.codeGrpId}" />">
		...
		<div class="cont_inWrap mt_20">
			...
			<div class="inputWrap mt_25">
				...
				<tr>
					...
					<td><input type="text" id="grpCodeName" name="grpCodeName" style="width:290px;" placeholder="코드명" value="<c:out value="${detail.codeGrpName}" />"></td>
				</tr>
